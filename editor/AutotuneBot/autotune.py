    ...
    if reformatAudio:
        ...
        loud_run(
            [
                ...
                "-ar",
                hz,
                base := chExt(addPrefix(absPath(base), "AT_"), "wav"),
            ]
        )
        loud_run(
            [
                ...
                "-t",
                str(baseDur),
                over := chExt(addPrefix(absPath(over), "AT_"), "wav"),
            ]
        )
...
def autotuneURL(
    filename, URL, replaceOriginal=True, video=True, executableName="./autotune.exe"
):
